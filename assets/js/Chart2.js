...
function getMinatData(){
  return fetch("http://34.229.17.61/minat/all")
...
function getPelatihanData(){
  return fetch("http://34.229.17.61/pelatihan/all")
  .then(response => response.json())
  .then(res => {
      const data = res.data;
      //kecamatan
...
function getcalonSertData(){
  return fetch("http://34.229.17.61/sertifikasi/calon/all")
  .then(response => response.json())
  .then(res => {
      const data = res.data;
      //Pelatihan
...
function getpesertaSertData(){
  return fetch("http://34.229.17.61/sertifikasi/peserta/all")
  .then(response => response.json())
  .then(res => {
      const data = res.data;
      //Pelatihan
